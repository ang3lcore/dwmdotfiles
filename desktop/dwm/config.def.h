...
static const char *mute[] = {"amixer", "-c", "1", "set", "Capture", "nocap", NULL};
static const char *unmute[] = {"amixer", "-c", "1", "set", "Capture", "cap", NULL};

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_Page_Down,   spawn,   {.v = mute } },
	{ MODKEY,                       XK_Page_Up,     spawn,     {.v = unmute } },
